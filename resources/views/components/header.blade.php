    ...
    <div class="row pt-2">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <div class="social d-flex">
                <!-- Tìm kiếm -->
                <div class="search-popup d-flex align-items-center me-3 border p-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tìm kiếm">
                ...
                @auth
                    <!-- Đăng nhập -->
                    <div class="d-flex align-items-center me-3 border p-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tên người dùng">
                    ...
                    <div class="d-flex align-items-center border p-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Đăng xuất">

                        <form action="{{ route('logout') }}" method="POST">
                            @csrf <!-- Token CSRF để bảo mật -->
                            <button type="submit" class="logout-link ms-2 bg-transparent border-0 p-0" title="Đăng xuất">
                ...
                @else
                    <!-- Đăng nhập -->
                    <div class="d-flex align-items-center me-3 border p-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Đăng nhập">
                    ...
                    <!-- Đăng ký -->
                    <div class="d-flex align-items-center border p-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Đăng ký">
