    ...
    <ul class="nav flex-column" id="sidebar-content">
        ...
        <li class="nav-item">
            ...
            <ul class="collapse" id="booksDropdown">
                <li><a class="dropdown-item" href="{{ route('books.listView')}}"><i class="fas fa-circle"></i> Danh sách sách</a></li>
                <li><a class="dropdown-item" href="{{ route('books.create') }}"><i class="fas fa-circle"></i> Thêm sách mới</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link custom-nav-link" href="#" id="settingsLink">
                <i class="fas fa-cogs icon-color"></i> Cài đặt
                <i class="fas fa-chevron-down float-end"></i> <!-- Biểu tượng mở/đóng -->
            </a>
            <ul class="collapse" id="settingsDropdown">
                <li><a class="dropdown-item" href="#"><i class="fas fa-circle"></i> Cài đặt chung</a></li>
                <li><a class="dropdown-item" href="#"><i class="fas fa-circle"></i> Quản lý giao diện</a></li>
            </ul>
        </li>
    </ul>
</div>
